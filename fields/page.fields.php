...
$page_postmetas = 
	array (
		...
		*/
		...
		array("section" => "Background Gallery", "id" => "page_bg_gallery_id", "type" => "select", "title" => "Background Gallery", "description" => "If you select \"Slideshow\" or \"Random\" as background style. Select a gallery here", "items" => $galleries_select),
