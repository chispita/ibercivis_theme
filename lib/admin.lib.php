...
array( "name" => "Your Contact Information",
	"desc" => "It will displays on the left side of every pages (HTML code support)",
	"id" => $shortname."_contact_info_text",
	"type" => "textarea",
	"std" => "You can add informations about yourself, service, pricing here using Theme admin.<br/><br/>@ipeerapong<br/>085.16778823"
),
...
array( "name" => "<h2>Global Colors Settings</h2>Active Skin Color",
	"desc" => "(default #f9d20b)",
...
array( "name" => "Hover Link Color",
	"desc" => "Select color for the hover background color (default #f9d20b)",
...
array( "name" => "H1, H2, H3, H4, H5, H6 Color",
	"desc" => "Select color for the H1, H2, H3, H4, H5, H6 (default #222222)",
...
array( "name" => "<h2>Main Menu Colors Settings</h2>Menu Font Color",
	"desc" => "Select color for menu font (default #000000)",
...
array( "name" => "Active Menu Font Color",
	"desc" => "Select color for active menu font (default #ffffff)",
...
array( "name" => "Menu Header Font Color",
	"desc" => "Select color for menu header font (default #ffffff)",
	"id" => $shortname."_menu_header_font_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#ffffff"
),
...
array( "name" => "Video Set pages Background Image",
	"desc" => "Select image for video set background (Recommended size 1440x900 pixels)",
